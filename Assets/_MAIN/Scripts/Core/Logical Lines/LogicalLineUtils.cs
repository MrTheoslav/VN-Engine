    ...
    public static class LogicalLineUtils
    {
        ...
        public static class Expressions
        {
            ...
            public static object CalculateValue(string[] expressionParts)
            {
                ...
                CalculateValue_DivisionAndMuliplication(operatorStrings, operands);
            ...
            private static void CalculateValue_DivisionAndMuliplication(List<string> operatorStrings, List<object> operands)
            {
            ...
            private static object ExtractValue(string value)
            {
                ...
                else
                {
                    ...
                    else if (float.TryParse(value, floatStyle, nfi, out float floatValue))
                    {
                        return floatValue;
                    }
        ...
        public static class Conditions
        {
            ...
            public static bool EvaulateCondition(string condition)
            {
