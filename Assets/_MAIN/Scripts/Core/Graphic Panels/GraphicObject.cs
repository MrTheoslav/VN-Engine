...
public class GraphicObject
{
    ...
    private void InitGraphic(bool immediate)
    {
        ...
        renderer.material = GetTransisionMaterial();
    ...
    private Material GetTransisionMaterial()
    {
    ...
    private IEnumerator Fading(float target, float speed, Texture blend)
    {
        ...
        {
            float opacity = Mathf.MoveTowards(renderer.material.GetFloat(opacityParam), target, speed * DEFAULT_FADING_SPEED * Time.deltaTime);
