...
{
    private const string KEY = "SECRETKEY";//Change it in every visual novel, maybe add some easter egg for hackers :)
    ...
    public static bool TryCreateDirectoryPath(string path)
    {
    ...
    {
        if (!TryCreateDirectoryPath(filePath))
        {
