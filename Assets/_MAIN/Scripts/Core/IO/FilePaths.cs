...
public class FilePaths
{
    ...
    /// <summary>
    /// Returns the path to the resource using the default path or the root of the folder if the resource name begins with the Home Directory Symbol
    /// </summary>
    /// <param name="defaultPath"></param>
    /// <param name="resourceName"></param>
    /// <returns></returns>
    public static string GetPathResource(string defaultPath, string resourceName)
    {
