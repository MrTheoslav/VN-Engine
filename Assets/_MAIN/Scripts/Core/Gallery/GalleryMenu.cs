...
public class GalleryMenu : MonoBehaviour
{
    ...
    [SerializeField] private GameObject panelSelectionButtonPrefab;
    ...
    private void ConstructNavBar()
    {
        ...
        prevButton.gameObject.SetActive(pageLimit < PAGE_BUTTON_LIMIT);
        nextButton.gameObject.SetActive(pageLimit < PAGE_BUTTON_LIMIT);
    ...
    private void ShowPreviewImage(Texture image)
    {
        ...
        previewPanelCG.Show();
        previewPanelCG.SetInteracableState(true);
    }

    public void HidePreviewImage()
    {
        previewPanelCG.Hide();
        previewPanelCG.SetInteracableState(false);
    }
