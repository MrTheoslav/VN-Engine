...
namespace CHARACTERS
{
    public abstract class Character
    {
        ...
        private const float UNHIGLIGHTED_DARKEN_STRENGTH = 0.65f;
        ...
        protected Color unhighlightedColor => new Color(color.r * UNHIGLIGHTED_DARKEN_STRENGTH, color.g * UNHIGLIGHTED_DARKEN_STRENGTH, color.b * UNHIGLIGHTED_DARKEN_STRENGTH, color.a);
        ...
        public virtual void SetPosition(Vector2 position)
        {
            ...
            (Vector2 minAnchorTarget, Vector2 maxAnchorTarget) = ConvertUITargetPositionToRelativeCharaterAnchorTargets(position);
        ...
        protected (Vector2, Vector2) ConvertUITargetPositionToRelativeCharaterAnchorTargets(Vector2 position)
        {
            Vector2 padding = root.anchorMax - root.anchorMin;
        ...
        public Coroutine Highlight(float speed = 1f, bool immediate = false)
        {
            ...
            highlighted = true;
            co_highlighting = characterManager.StartCoroutine(Highlitghting(speed, immediate));
        ...
        public virtual IEnumerator Highlitghting(float speedMultiplier, bool immediate = false)
        {
        ...
        }//Currently not working in text file
